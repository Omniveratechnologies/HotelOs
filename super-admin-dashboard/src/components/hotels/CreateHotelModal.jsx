...
export default function CreateHotelModal({
  ...
  function validate() {
    ...
    if (!adminUsername.trim()) {
      next.adminUsername =
        "Sub Admin username is required.";
    } else if (
    ...
    >
      ...
      >
        ...
        <div className="border-t border-line pt-5">
          ...
          <p className="mt-1 text-xs text-ink-muted">
            This person will receive an invitation email
            and manage the hotel account.
          </p>
        </div>
