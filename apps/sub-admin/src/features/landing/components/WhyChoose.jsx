  ...
  return (
    <section id="features" className="bg-white py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <h2 className="font-display text-brand-900 mb-16 text-center text-4xl font-semibold">
          Why Hotels Choose HotelOS
        </h2>
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          {reasons.map((r) => (
            <div key={r.title} className="text-center">
              <span className="border-primary-400/20 bg-primary-400/10 mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full border">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  {r.icon}
                </svg>
              </span>
              <p className="text-brand-900 mb-1.5 font-medium">{r.title}</p>
