...
function SettingsForm({ hotel, onSave, saving }) {
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xs">
        ...
        <div className="grid gap-5 px-6 py-5 sm:grid-cols-2">
          ...
          <div>
            ...
            <p className="text-brand-900 mt-1 text-sm">{hotel.email || "—"}</p>
          </div>
        ...
        <div className="px-6 py-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Input
              ...
              onChange={(e) => setField("wifiNetworkName", e.target.value)}
            />
...
export default function SettingsPage() {
  ...
  const updateMyHotelMutation = useUpdateMyHotel();
  const [toast, setToast] = useState("");

  async function handleSave(payload) {
    try {
      await updateMyHotelMutation.mutateAsync(payload);
      ...
      <main className="max-w-3xl px-6 py-8 lg:px-10">
        ...
        {loading ? (
          ...
          <SettingsForm
            ...
            hotel={hotel}
            onSave={handleSave}
            saving={updateMyHotelMutation.isPending}
          />
        ) : null}
      </main>
    </div>
