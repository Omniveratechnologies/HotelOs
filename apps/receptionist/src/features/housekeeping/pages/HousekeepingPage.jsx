...
export default function HousekeepingPage() {
  ...
  const serviceRequestRequests = serviceRequests.filter(
    (r) => r.status === "requested",
  );
  const serviceRequestCompleted = serviceRequests.filter(
  ...
  return (
    <>
      <Header
        pageTitle="Housekeeping & Service Requests"
        pageDescription={`${serviceRequestRequests.length} pending • ${serviceRequestCompleted.length} completed today`}
      >
        <button
