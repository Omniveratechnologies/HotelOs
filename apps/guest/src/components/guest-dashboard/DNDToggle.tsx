...
export function DNDToggle({
  ...
  return (
    ...
    >
      <BellRing
        className={cn("size-5 shrink-0", enabled && "animate-pop")}
        aria-hidden="true"
      />
      <div className="min-w-0 flex-1">
        ...
        >
          {pending
            ? "Syncing…"
            : enabled
              ? "Active — staff won't disturb you"
              : "Service allowed"}
        </p>
      </div>
      <Switch
        ...
        className="focus-visible:ring-ring data-[state=checked]:bg-primary focus-visible:ring-2 focus-visible:ring-offset-2"
      />
