...
export default function Dashboard() {
  ...
  const handleSendReceptionistInvite = async (e) => {
    ...
    const email = receptionistEmail.trim().toLowerCase();

    if (!email) {
      setInviteError("Please enter the receptionist's email.");
      return;
    }
    ...
    try {
      ...
      await sendReceptionistInvitation(email);
        ...
        <main className="px-6 lg:px-10 py-8">
          ...
          <div className="bg-cream border border-beige-border rounded-2xl shadow-card p-6 mb-8">
            ...
            {showReceptionistForm && (
              ...
              <div className="mt-6 pt-6 border-t border-beige-border">

                <form
                  onSubmit={
                    handleSendReceptionistInvite
                  }
                  className="max-w-xl"
                >
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-beige-border bg-white px-4 py-3 text-navy outline-none focus:ring-2 focus:ring-gold"
                    disabled={sendingInvite}
                  />

                  <p className="text-xs text-muted mt-2">
                    An invitation link will be sent to
                    this email. The receptionist will
          ...
          <div className="bg-cream border border-beige-border rounded-2xl shadow-card p-6">
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <a
                href="#"
                className="text-sm text-gold font-medium hover:text-gold-hover"
              >
                View all
              </a>
